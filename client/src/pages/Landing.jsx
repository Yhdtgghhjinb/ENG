        ...
        <div className="max-w-7xl mx-auto w-full">
          ...
          <motion.div
                ...
                <motion.div
                  animate={{
                    boxShadow: [
                      ...
                      '0 0 80px 30px rgba(139,92,246,0.5)',
            ...
            <motion.div
              ...
              <Link to="/home" className="group relative">
                ...
                <motion.div
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="relative w-48 h-48 sm:w-56 sm:h-56 rounded-full overflow-hidden cursor-pointer"
                  style={{
                    background: 'linear-gradient(135deg, #6366f1, #8b5cf6, #ec4899)',
                    boxShadow: '0 30px 60px rgba(99,102,241,0.4), inset 0 2px 10px rgba(255,255,255,0.3)',
                  }}>
                  ...
                  <div className="relative z-10 h-full flex flex-col items-center justify-center gap-3">
                    ...
                    <motion.div
                      ...
                      <div className="text-white font-black text-xl sm:text-2xl tracking-wider drop-shadow-lg">
                        ENTER
                      </div>
                      <motion.div
                        animate={{ x: [0, 5, 0] }}
                        transition={{ duration: 1, repeat: Infinity }}
                        className="text-white/80 text-xs sm:text-sm font-bold mt-1">
                        Click to Start →
                      </motion.div>
                    </motion.div>
                  </div>
            ...
            <motion.div
              ...
              {[
                ...
                <motion.div
                  ...
                  className="rounded-2xl p-4 sm:p-5 text-center group cursor-pointer"
                  style={{
            ...
            <motion.div
              ...
              <span className="font-medium">System Online • Ready to Use</span>
            </motion.div>
          </motion.div>
        </div>
      </div>
