    ...
    <div className="pb-16">
      ...
      <div className="mt-3 mb-3 md:mt-4 md:mb-4">
        ...
        <div className="flex items-start gap-2.5 md:gap-3 mb-2 md:mb-3">
          ...
          <div className="flex-1 min-w-0">
            <h1 className="text-lg md:text-xl font-bold text-white mb-1 md:mb-1.5">{subject?.name}</h1>
            
            {/* Academic Info Chips - Desktop */}
            <div className="hidden md:flex items-center gap-1.5 flex-wrap">
              {subject?.code && (
                <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-lg text-xs font-semibold font-mono bg-indigo-500/20 text-indigo-300 border border-indigo-500/30">
              ...
              {subject?.semesterNumber && (
                <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-lg text-xs font-medium bg-cyan-500/20 text-cyan-300 border border-cyan-500/30">
                  <svg className="w-3 h-3" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
              ...
              {subject?.scheme && (
                <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-lg text-xs font-medium bg-orange-500/20 text-orange-300 border border-orange-500/30">
                  <svg className="w-3 h-3" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
              ...
              {subject?.credits && (
                <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-lg text-xs font-medium bg-emerald-500/20 text-emerald-300 border border-emerald-500/30">
                  <svg className="w-3 h-3" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
              ...
              {(subject?.lectureHours || subject?.tutorialHours || subject?.practicalHours) && (
                <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-lg text-xs font-medium bg-purple-500/20 text-purple-300 border border-purple-500/30">
                  <svg className="w-3 h-3" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
        ...
        <div className="hidden md:flex gap-1.5 justify-end">
          <div className="px-2.5 py-1 rounded-lg text-center" style={{ background: 'rgba(99,102,241,0.1)', border: '1px solid rgba(99,102,241,0.2)' }}>
            <div className="text-sm font-bold text-white">{sectionCounts.notes}</div>
          ...
          <div className="px-2.5 py-1 rounded-lg text-center" style={{ background: 'rgba(6,182,212,0.1)', border: '1px solid rgba(6,182,212,0.2)' }}>
            <div className="text-sm font-bold text-white">{sectionCounts.pyq}</div>
          ...
          <div className="px-2.5 py-1 rounded-lg text-center" style={{ background: 'rgba(139,92,246,0.1)', border: '1px solid rgba(139,92,246,0.2)' }}>
            <div className="text-sm font-bold text-white">{sectionCounts.textbook}</div>
      ...
      {/* ═══════════════ STICKY SEARCH BAR ═══════════════ */}
      <div className="sticky top-0 z-20 bg-[#020617] py-1.5 md:py-2 -mx-4 px-4 md:mx-0 md:px-0 md:static md:mb-3 mb-2 border-b md:border-b-0 border-white/5">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-1.5 md:py-2 rounded-lg bg-white/5 border border-white/10 text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 transition-all text-sm touch-manipulation"
          />
        </div>
      </div>
          ...
          <div className="flex gap-1.5 min-w-max pb-1.5 md:pb-0">
            {SECTIONS.filter(s => sectionCounts[s.key] > 0).map(section => (
              <button
                ...
                className="flex items-center gap-1.5 px-2.5 md:px-3 py-1.5 md:py-2 rounded-lg text-xs md:text-sm font-medium transition-all whitespace-nowrap touch-manipulation min-h-[38px] md:min-h-[40px]"
                style={{
