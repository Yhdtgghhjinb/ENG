      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4">
          ...
          <motion.div
            ...
            className="relative w-full overflow-hidden rounded-t-2xl sm:rounded-2xl"
            style={{
          ...
          >
            ...
            <div className="flex items-center justify-between px-4 sm:px-6 py-3 sm:py-4"
              ...
              <button onClick={onClose}
                className="flex h-7 w-7 items-center justify-center rounded-lg text-slate-500 transition-colors hover:text-slate-200 active:scale-95"
            ...
            <div className="max-h-[calc(90vh-60px)] overflow-y-auto p-4 sm:p-6">
              {children}
            </div>
          </motion.div>
        </div>
